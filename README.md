...
중간에 저장을 한번 잘못하는 바람에 main 내용을 날렸었는데... 저장전에는 한번 더 확인하는 습관을 가져야겠다.. 그리고 css 크기 조절 이라고 해야하나 어떤식으로 사이즈를 정해야할지 모르겠다 피그마 보고 정하긴 했는데 반응형으로 만들려면 이렇게 하면 안되는 것 잘 모르겠다. 진행하면서 git commit도 수정해보고 html도 css도 복습하고 도움이 많이 된 것 같다.
